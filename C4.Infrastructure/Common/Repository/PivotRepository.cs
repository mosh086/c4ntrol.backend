...
namespace C4.Infrastructure.Common.Repository;

public abstract class PivotRepository<TEntity> : IPivotRepository<TEntity>
    where TEntity : class
{
    protected readonly C4ntrolDbContext Context;
    protected readonly DbSet<TEntity> Entity;

    protected PivotRepository(C4ntrolDbContext context)
    {
