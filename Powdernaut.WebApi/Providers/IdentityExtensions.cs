...
using Powdernaut.Infrastructure.Data.Constants;
...
using Powdernaut.Infrastructure.Identity.Service;
using Powdernaut.Infrastructure.Identity.Polymorphism;
...
public static class IdentityExtensions
{
    ...
    private static IServiceCollection AddIdentityServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        .AddEntityFrameworkStores<PowdernautDbContext>()
        .AddRoles<RoleEntity>()
