using C4.Application;
using C4.Application.Utilities.Extensions;
using C4.Infrastructure;
using C4.Infrastructure.Data;
using C4.Infrastructure.Identity.Models;
using C4.WebApi.Middlewares.AuthorizedHandler;
using C4.WebApi.Middlewares.ExceptionHandler;
using C4.WebApi.Providers;
