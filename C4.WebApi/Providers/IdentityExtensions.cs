...
using C4.Infrastructure.Identity.Service;
using C4.Infrastructure.Identity.Polymorphism;

namespace C4.WebApi.Providers;
...
public static class IdentityExtensions
{
    ...
    private static IServiceCollection AddIdentityServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        .AddEntityFrameworkStores<C4ntrolDbContext>()
        .AddRoles<RoleEntity>()
