...
namespace Powdernaut.Infrastructure.Common.Repository;
...
public abstract class BaseRepository<TEntity, TId> : IBaseRepository<TEntity, TId>
    ...
    where TId : struct,
          ...
          IFormattable
{
    protected readonly PowdernautDbContext Context;
    protected readonly DbSet<TEntity> Entity;

    protected BaseRepository(PowdernautDbContext context)
    {
